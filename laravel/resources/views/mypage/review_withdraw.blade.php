...
<body>
    ...
    <header>
        <div class="product_list_header">
            <div class="product_list_header">
                <h2 class="header_h2">商品レビュー削除確認</h2>
            </div>
            <div>
    ...
    <main>
        <div class="detail_container">
            ...
            <form action="{{ route('mypage_review_withdraw_complete', ['id' => $review->id]) }}" method="post" onsubmit="disableSubmitButton()">
                @csrf
                ...
                <div class="review_submit">
                    <input type="submit" id="submitBtn" name="" value="レビューを削除する" class="review_subimt_btn">
                </div>
            </form>

            <div class="detail_back_submit">
                <a href="{{ route('mypage_review', ['page' => $request->query('page')]) }}" class="review_submit_back_btn">前に戻る</a>
            </div>
        </div>
    </main>
    <script>
